...
class DistributedGolfCourseAI(DistributedObjectAI.DistributedObjectAI, FSM):
    ...
    defaultTransitions = {
                          ...
                          "WaitReadyHole": ["PlayHole", "Cleanup"],
                          "PlayHole": ["WaitReward", "WaitLeaveHole", "WaitReadyHole", "Cleanup"],
                          "WaitLeaveHole": ["WaitReward", "WaitReadyHole", "Cleanup"],
                          "WaitReward": ["WaitLeaveCourse", "WaitLeaveHole", "Cleanup"],
