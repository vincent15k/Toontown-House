...
MakeAToonNameBlacklist = [
    ...
    'shit', 'suck', 'negro', 'nigger',
    'whore', 'maconha', 'weed', 'faggot',
    'gay', 'buttplug', 'cocaine', 'heroin',
    'lsd', 'puta', 'buceta', 'pepeca',
    'bilau', 'merda', 'bosta', 'lixo',
    'porra', 'caralho', 'crack', 'cocaina',
    'heroina', 'drug', 'droga', 'funkeiro',
    'blowjob', 'handjob', 'footjob', 'wank',
    'punheta', 'masturb', 'boquete',
    'garganta profunda', 'deep throat',
    'fisting', 'anus', 'dedada', 'rape',
    'sex', 'estupro', 'ejacula', 'dildo',
    'brinquedinhos', 'finger', 'zoofilia',
    'xxx', 'xvideos', 'redtube', 'lesbic',
    'homosexual', 'bastard', 'noodles',
    'marijuana', 'cuzinho', 'transa', 'anal',
    'fresh', 'peepee', 'cannabis', 'pedo',
    'pervert', 'shroom', 'reggin', 'tobacco'
]
